...
namespace Pmi.Certification.Functional.Tests
{
    ...
    public class ProjectExperiencePage : BasePage<ProjectExperiencePage>
    {
        ...
        public ProjectExperiencePage(IWebDriver driver) : base(driver)
        {
        ...
        public ProjectExperiencePage VerifyPmiLogo()
        {
        ...
        public ProjectExperiencePage FillExperienceDetails(TestData testData, String experienceType)
        {
            Thread.Sleep(5000);
            ...
            Thread.Sleep(3000);
            _wait.Until(_ => ContinueToProgramExperienceEnabled());
            return this;
        }
        ...
        public ProjectExperiencePage VerifyExperienceDetails(TestData testData, String experienceType)
        {
            try
            {
        ...
        private bool ContinueToProgramExperienceEnabled() => Extensions.Extensions.CatchUnavailableElement(() => ContinueToProgramExp.Displayed && ContinueToProgramExp.Enabled, false);

        public ProjectExperiencePage VerifyExperienceSummaryDetails(TestData _testData, string experienceType)
        {
        ...
        public ProjectExperiencePage ClickAdditionalExperience(TestData testData, String experienceType)
        {
        ...
        public ProjectExperiencePage EditProfessionalExperience(TestData testData, String experienceType)
        {
        ...
        public ProjectExperiencePage RemoveExperienceDetails(String experienceType)
        {
        ...
        public ProjectExperiencePage AdditionalExperience(String experienceType)
        {
        ...
        public ProjectExperiencePage VerifyPMPBadge(String experienceType)
        {
        ...
        public ProjectExperiencePage VerifyAndClickContinueToProgramExperience()
        {
