 ...
 */
let appName = env.SITECORE_JSS_APP_NAME;

/**
 * The server.bundle.js file from your pre-built JSS app
 */
const bundlePath = env.SITECORE_JSS_SERVER_BUNDLE || `./dist/${appName}/server.bundle`;
...
const config = {
   ...
   */
  apiHost: env.SITECORE_API_HOST || 'http://sc911.local',
  /**
   ...
   */
  layoutServiceRoute:
    env.SITECORE_LAYOUT_SERVICE_ROUTE || '/sitecore/api/layout/render/jss',
  /**
   * apiKey: The Sitecore SSC API key your app uses.
   * Required.
   */
  apiKey: env.SITECORE_API_KEY || serverBundle.apiKey || '{YOUR API KEY HERE}',
  /**
  ...
  nodeServerPort: env.SITECORE_NODE_SERVER_PORT,
  disableSSR: env.DISABLE_SSR
};
