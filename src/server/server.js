...
global.certAppConfig = config;

import GraphQLClientFactory from '../Foundation/Infrastructure/client/api/GraphQL/GraphQLClientFactory';
import i18ninit from '../Project/Certification/client/i18n';
import AppRoot, { routePatterns } from '../Project/Certification/client/AppRoot';
