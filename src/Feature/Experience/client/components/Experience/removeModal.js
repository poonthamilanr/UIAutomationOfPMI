    ...
    >
      <Modal.Header closeButton>
        <Modal.Title id="RemoveModalTitle">
          {i18n.t('cert-app.Experience.ProjectExperience.RemoveExperienceModalTitle')}
        </Modal.Title>
      </Modal.Header>
      <Modal.Body id="RemoveModalDesc" />
      <Modal.Footer>
        <Button variant="outline-primary" onClick={onHide} titleText={i18n.t('cert-app.Common.Cancel')} />
        <Button variant="primary" onClick={onRemove} titleText={i18n.t('cert-app.Experience.ProjectExperience.RemoveExperience')} />
      </Modal.Footer>
    </Modal>
  );
};
