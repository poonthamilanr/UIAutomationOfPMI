 ...
 */
module.exports = function generateConfig(configOverridePath) {
  const defaultConfig = {
  ...
  const scjssConfig = transformScJssConfig(configOverridePath);
  ...
  const config = Object.assign(defaultConfig, scjssConfig, packageJson);
...
function transformScJssConfig(configOverridePath) {
  ...
  return {
    sitecoreInstanceUrl: config.sitecore.sitecoreInstanceUrl,
    authReturnRoot: config.sitecore.authReturnRoot,
    sitecoreApiKey: config.sitecore.apiKey,
    sitecoreApiHost: config.sitecore.layoutServiceHost,
    profileApiServiceRoot: config.sitecore.profileApiServiceRoot,
    applicationApiServiceRoot: config.sitecore.applicationApiServiceRoot,
    orchestrationApiServiceRoot: config.sitecore.orchestrationApiServiceRoot,
    certificationApiServiceRoot: config.sitecore.certificationApiServiceRoot,
    pageNotFoundPath: config.sitecore.pageNotFoundPath
  };
}
